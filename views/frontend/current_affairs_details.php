                ...
                <div class="col-md-8 col-sm-8">
					<div class="details-block">
						<div class="detail-img">
							<img src="<?php echo base_url(); ?>uploads/<?php echo $cuurent_aff->image;?>" class="imgdetails" alt="">
						</div>

						<div class="details-data">
							<h4><?php echo $cuurent_aff->title;?></h4>

							<h6><span><?php $newDate = date("M d,Y", strtotime($cuurent_aff->date)); echo $newDate; ?></span></h6>

							<p><?php echo $cuurent_aff->description;?></p>
							<p><b>Read More:</b> <a href="<?php echo $cuurent_aff->refrence_link; ?>" target="_blank"><?php echo $cuurent_aff->refrence_link; ?></a></p>
						</div>
					</div>
					<h3 class="hclass"><b>Current Affairs List</b></h3>
					<div class="news-listing-wrp">
						<?php if(!empty($current_affairs_list)) { foreach($current_affairs_list as $ndata){ ?>
