                    ...
                    <li>
						...
						<label>Year</label>
                            <select class="form-control" id="year" name="year" onchange="selectyear()">
                                ...
                                <option value="2018" <?php if($this->input->post('year') == '2018'){ echo 'selected';} ?>>2018</option>
                                <option value="2019" <?php if($this->input->post('year') == '2019'){ echo 'selected';} ?>>2019</option>
                            </select>
                        </div>
                    </li>
                    <li>
						...
						<label>Company</label>
                            <select class="form-control whatever" name="company" id="company" onchange="selectcompany()">
                                ...
                                <?php foreach($company as $cdata){ ?>
									<option value="<?php echo $cdata->id; ?>" <?php if($this->input->post('company') == $cdata->id){ echo 'selected';} ?>><?php echo $cdata->company_name; ?></option>
								<?php } ?>
                            </select>
                        </div>
                    </li>
						...
						<label>Category</label>
							...
							<option value=""></option>
                                <?php foreach($category as $ctdata) { ?>
									<option value="<?php echo $ctdata->id; ?>" <?php if($this->input->post('cat') == $ctdata->id){ echo 'selected';} ?>><?php echo $ctdata->name; ?></option>
								<?php } ?>
                            </select>
                        </div>
                    </li>
						...
						<label>Subcategory</label>
							...
							<option value=""></option>
                                <?php foreach($category_subcategory as $sdata) { ?>
									<option value="<?php echo $sdata->id; ?>" <?php if($this->input->post('subcat') == $sdata->id){ echo 'selected';} ?>><?php echo $sdata->name; ?></option>
								<?php } ?>
                            </select>
                        </div>
                    </li>
                        ...
                        <div class="filter-box">
                            ...
                            <select class="form-control whatever3" name="inspector" id="inspector">
								...
								<?php foreach($inspector as $idata) { ?>
									<option value="<?php echo $idata->id; ?>" <?php if($this->input->post('inspector') == $idata->id){ echo 'selected';} ?>><?php echo $idata->name; ?></option>
								<?php } ?>                            
								</select>
                        </div>
                    </li>
